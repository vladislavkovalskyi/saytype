...
/// Makes the hosting window exactly `size`, title bar included, as in the mockups.
/// `NSWindow(contentRect:)` adds the title bar height on top of the content rect.
struct WindowFrameSizer: NSViewRepresentable {
    let size: CGSize
    ...
    private final class SizerView: NSView {
        ...
        override func viewDidMoveToWindow() {
            ...
            guard let window, window.frame.size != size else { return }
